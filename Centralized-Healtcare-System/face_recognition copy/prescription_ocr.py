...
def prescriptionn(path):
    ...
    os.environ['GOOGLE_APPLICATION_CREDENTIALS']= os.path.join(os.path.dirname(os.path.realpath(__file__)),"central-healthcare-system-38dc26f491a5.json")
...
prescriptionn("C:/Users/Raghav Jindal/Desktop/Centralized-Healtcare-System/face_recognition copy/prescriptions/pres1.jpeg")